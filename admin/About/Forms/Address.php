...
$mondayFriday = $businessHours[0]["Hours"];
$satSun = $businessHours[1]["Hours"];
?>

<dialog id="business-hours" class="w-11/12 md:w-1/2 p-5 bg-white rounded-md">
    <div class="flex flex-col w-full h-auto ">
        ...
        <div class="flex w-full h-auto justify-end items-center">
            ...
            <div onclick="document.getElementById('business-hours').close();" class="flex w-1/12 h-auto justify-center cursor-pointer">
